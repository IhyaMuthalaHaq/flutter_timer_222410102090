...
class TimerApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'Timer', // Mengubah judul aplikasi
      theme: ThemeData(
        primarySwatch: Colors.red, // Mengubah warna tema menjadi merah
...
class TimerPageOne extends StatefulWidget {
  @override
  _TimerPageOneState createState() => _TimerPageOneState();
}
...
class TimerPageTwo extends StatefulWidget {
  ...
  TimerPageTwo({required this.minutes});

  @override
  _TimerPageTwoState createState() => _TimerPageTwoState();
}
          ...
          if (totalSeconds > 0) {
            ...
            if (totalSeconds == 0) {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => TimerPageThree(),
                ),
              );
            }
          } else {
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                child: Text(_isTimerRunning ? 'BERHENTI' : 'LANJUT'),
              ),
            ],
          ),
        ),
